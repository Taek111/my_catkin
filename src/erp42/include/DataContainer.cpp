...
double DataContainer::getValue_PCtoU_Steer_degree() { mtx_PCtoU_Steer_degree.lock(); double temp = PCtoU_Steer_degree; mtx_PCtoU_Speed_kph.unlock(); return temp; }
...
void DataContainer::setValue_PCtoU_Steer_degree(double value) { mtx_PCtoU_Steer_degree.lock();PCtoU_Steer_degree = value; mtx_PCtoU_Speed_kph.unlock();}
...
double DataContainer::getValue_UtoPC_Steer_degree() { mtx_UtoPC_Steer_degree.lock(); double temp = UtoPC_Steer_degree; mtx_UtoPC_Speed_kph.unlock(); return temp; }
...
void DataContainer::setValue_UtoPC_Steer_degree(double value) { mtx_UtoPC_Steer_degree.lock();UtoPC_Steer_degree = value; mtx_UtoPC_Speed_kph.unlock();}
